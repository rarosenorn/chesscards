<!-- https://www.svgrepo.com/svg/279724/snowflake
     The source lays black detail shapes over a pale body. Only the detail
     is kept, in currentColor: the two tones would fight the toggle's
     grey/accent states, and filling the body instead swallows the arms —
     the flake rasterizes as a blob. -->
<svg
	viewBox="0 0 512 512"
	width="1em"
	height="1em"
