...
<style>
	/* The card's exact board sizes (app.css "card board layout"): paired
	   boards are the card's 404px cells --board-col-gap apart, a lone board
	...
	/* Full width, like the text: both edges shared. The card's exact board
	   ...
	   their content to 828px (two 404 card cells + the 20px --board-col-gap
	   between them), so fluid halves ARE 404 and a lone board's 563 fits as
	   on the card. */
	.board-grid-block {
		display: grid;
